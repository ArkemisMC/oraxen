...
public class WateringMechanic extends Mechanic {
    ...
    public boolean isEmpty() {
        return (emptyCanItem == null && filledCanItem != null);
    }

    public boolean isFilled() {
        return (filledCanItem == null && emptyCanItem != null);
    }

    public String getEmptyCanItem() {
        return this.emptyCanItem;
    }

    public String getFilledCanItem() {
        return this.filledCanItem;
    }
}
