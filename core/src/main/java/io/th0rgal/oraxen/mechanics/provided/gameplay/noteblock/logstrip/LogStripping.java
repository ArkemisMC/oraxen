...
public class LogStripping {
    ...
    public boolean canBeStripped() {
        return strippedLog != null;
    }

    public String getStrippedLogBlock() {
        return strippedLog;
    }

    public boolean hasStrippedDrop() {
        return dropFromStrippedLog != null;
    }

    public String getStrippedLogDrop() {
        return dropFromStrippedLog;
    }
