...
public class PredicatesGenerator {
    ...
    private static final String HANGING_ROOTS_DISPLAY = """
            {"thirdperson_righthand": {"rotation": [0,0,0],"translation": [0,0,1],"scale": [0.55,0.55,0.55]}, "firstperson_righthand": {"rotation": [0,-90,25],"translation": [1.13,0,1.13],"scale": [0.68,0.68,0.68]}}"""
            .trim();
    ...
    private static final String SMALL_DRIPLEAF_DISPLAY = """
            {"thirdperson_righthand": {"rotation": [0,0,0],"translation": [0,4,1],"scale": [0.55,0.55,0.55]}, "firstperson_righthand": {"rotation": [0,45,0],"translation": [0,3.2,0],"scale": [0.4,0.4,0.4]}}"""
            .trim();
    private static final String BIG_DRIPLEAF_DISPLAY = """
            {"gui": {"rotation": [30,225,0],"translation": [0,-2,0],"scale": [0.625,0.625,0.625]}, "fixed": {"rotation": [0,0,0],"translation": [0,0,-1],"scale": [0.5,0.5,0.5]}, "thirdperson_righthand": {"rotation": [0,0,0],"translation": [0,1,0],"scale": [0.55,0.55,0.55]}, "firstperson_righthand": {"rotation": [0,0,0],"translation": [1.13,0,1.13],"scale": [0.68,0.68,0.68]}}"""
            .trim();
    private static final String DRAGON_HEAD_DISPLAY = """
            {"gui": {"translation": [-2,2,0],"rotation": [30,45,0],"scale": [0.6,0.6,0.6]}, "thirdperson_righthand": {"rotation": [0,180,0],"translation": [0,-1,2],"scale": [0.5,0.5,0.5]}}"""
            .trim();
    private static final String CONDUIT_DISPLAY = """
            {"gui":{"rotation":[30,45,0],"translation":[0,0,0],"scale":[1,1,1]},"ground":{"rotation":[0,0,0],"translation":[0,3,0],"scale":[0.5,0.5,0.5]},"head":{"rotation":[0,180,0],"translation":[0,0,0],"scale":[1,1,1]},"fixed":{"rotation":[0,180,0],"translation":[0,0,0],"scale":[1,1,1]},"thirdperson_righthand":{"rotation":[75,315,0],"translation":[0,2.5,0],"scale":[0.5,0.5,0.5]},"firstperson_righthand":{"rotation":[0,315,0],"translation":[0,0,0],"scale":[0.8,0.8,0.8]}}"""
            .trim();
    private static final String DECORATED_POT_DISPLAY = """
            {"thirdperson_righthand":{"rotation":[0,90,0],"translation":[0,2,0.5],"scale":[0.375,0.375,0.375]},"firstperson_righthand":{"rotation":[0,90,0],"translation":[0,0,0],"scale":[0.375,0.375,0.375]},"gui":{"rotation":[30,45,0],"translation":[0,0,0],"scale":[0.6,0.6,0.6]},"ground":{"rotation":[0,0,0],"translation":[0,1,0],"scale":[0.25,0.25,0.25]},"head":{"rotation":[0,180,0],"translation":[0,16,0],"scale":[1.5,1.5,1.5]},"fixed":{"rotation":[0,180,0],"translation":[0,0,0],"scale":[0.5,0.5,0.5]}}"""
            .trim();
    ...
    public PredicatesGenerator(final Material material, final List<ItemBuilder> items) {
        ...
        if (material == Material.TIPPED_ARROW) {
            ...
            textures.addProperty("layer0", vanillaTextureName);
            textures.addProperty("layer1", vanillaTextureName + "_overlay");
        } else if (exampleMeta instanceof SpawnEggMeta)
            ...
            case LIGHT -> {
                ...
                for (int i = 0; i < 16; i++) {
                    ...
                    overrides.add(getOverride(JsonParser.parseString(lightPredicate.toString()).getAsJsonObject(),
                            "item/light_" + (i >= 10 ? i : "0" + i)));
                }
            }
            case CHEST, ENDER_CHEST, TRAPPED_CHEST ->
                    json.add("display", JsonParser.parseString(CHEST_DISPLAY).getAsJsonObject());
            case LARGE_AMETHYST_BUD ->
                    json.add("display", JsonParser.parseString(LARGE_AMETHYST_BUD_DISPLAY).getAsJsonObject());
            case SMALL_DRIPLEAF ->
                    json.add("display", JsonParser.parseString(SMALL_DRIPLEAF_DISPLAY).getAsJsonObject());
        ...
        for (final ItemBuilder item : items) {
            ...
            if (oraxenMeta.hasBlockingModel()) {
                ...
                overrides.add(
                        getOverride(predicate, "custom_model_data", customModelData, oraxenMeta.getBlockingModel()));
            }
            if (oraxenMeta.hasChargedModel()) {
                final JsonObject predicate = new JsonObject();
                predicate.addProperty("charged", 1);
                overrides.add(
                        getOverride(predicate, "custom_model_data", customModelData, oraxenMeta.getChargedModel()));
            }
            if (oraxenMeta.hasFireworkModel()) {
                ...
                overrides.add(
                        getOverride(predicate, "custom_model_data", customModelData, oraxenMeta.getFireworkModel()));
            }
            ...
            if (oraxenMeta.hasDamagedModels()) {
                ...
                for (int i = 0; i <= damagedModels.size(); i++) {
                    ...
                    overrides.add(
                            getOverride(predicate, "custom_model_data", customModelData, damagedModels.get(i - 1)));
                }
            }
    ...
    private static boolean has2DBlockIcon(Material material) {
        ...
        if (material == Material.SEA_PICKLE || material == Material.POINTED_DRIPSTONE || material == Material.BELL)
            return true;
        if (material == Material.COMPARATOR || material == Material.REPEATER)
            return true;
        if (material == Material.FLOWER_POT || material == Material.BREWING_STAND)
            return true;
        if (material == Material.CAULDRON || material == Material.HOPPER)
            return true;
        if (material == Material.SUGAR_CANE || material == Material.BAMBOO)
            return true;
        if (material == Material.NETHER_WART || material == Material.WHEAT || material == Material.CAKE)
            return true;
        ...
        if (Tag.DOORS.isTagged(material))
            return true;
        if (Tag.CANDLES.isTagged(material))
            return true;
    ...
    private String getParent(final Material material) {
        ...
        if (material == Material.SPORE_BLOSSOM || material == Material.BIG_DRIPLEAF || material == Material.AZALEA
        ...
        if (material == Material.CHORUS_FLOWER || material == Material.CHORUS_PLANT || material == Material.END_ROD)
            return "block/" + materialName;
        if (material == Material.SMALL_AMETHYST_BUD || material == Material.MEDIUM_AMETHYST_BUD
